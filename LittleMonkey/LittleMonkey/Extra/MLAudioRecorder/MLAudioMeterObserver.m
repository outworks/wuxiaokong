...
- (void)refresh
{
    ...
    IfAudioQueueErrorPostAndReturn(AudioQueueGetProperty(_audioQueue, kAudioQueueProperty_CurrentLevelMeterDB, _levelMeterStates, &data_sz),NSLocalizedString(@"GetMeterDataFail", nil));
